...
namespace TwainDotNet
{
    public class Capability
    {
		...
		private class TWCap
		{
			ContainerType _containerType { get; set; }
			IntPtr _handle { get; set; }
		}
		...
		public static List<object> GetCapability(Capabilities capability, Identity applicationId, Identity sourceId)
	    {
			var c = new Capability(capability, TwainType.Int16, applicationId, sourceId);
			var capResult = c.GetValue();
			return capResult;
	    }
    }
}
