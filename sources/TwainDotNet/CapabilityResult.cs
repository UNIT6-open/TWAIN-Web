...
namespace TwainDotNet
{
    ...
    public class BasicCapabilityResult : CapabilityResult
    {
		...
		public CapabilityArrayValue ArrayValue { get; set; } 
		public CapabilityRangeValue RangeValue { get; set; } 
		public CapabilityEnumValue EnumValue { get; set; }
		public CapabilityOneValue OneValue { get; set; }
    }
}
